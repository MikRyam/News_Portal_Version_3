...
class Post(models.Model):
    ...
    categoryType = models.CharField(max_length=2,
                                     choices=CATEGORIES,
                                     default=ARTICLE)
    pubDate = models.DateTimeField('дата и время публикации статьи/новости', auto_now_add=True)
    postCategory = models.ManyToManyField(Category, through='postCategory')
    postTitle = models.CharField('название статьи/новости', max_length=128)
    postText = models.TextField('текст статьи/новости')
